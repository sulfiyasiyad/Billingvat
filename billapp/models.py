...
class CreditNoteReference(models.Model):
    user = models.ForeignKey(CustomUser,on_delete=models.CASCADE,null=True,blank=True)
    company = models.ForeignKey(Company,on_delete= models.CASCADE,null=True,blank=True)
    credit_note = models.ForeignKey(CreditNote, related_name='references', on_delete=models.CASCADE,null=True,blank=True)
    reference_no = models.CharField(max_length=100, blank=True,null=True)

class CreditNoteItem(models.Model):
    user = models.ForeignKey(CustomUser,on_delete=models.CASCADE,null=True,blank=True)
    credit_note = models.ForeignKey(CreditNote, related_name='items', on_delete=models.CASCADE, null=True, blank=True)
    company = models.ForeignKey(Company,on_delete= models.CASCADE,null=True,blank=True)
...
class CreditNoteHistory(models.Model):
    user = models.ForeignKey(CustomUser,on_delete=models.CASCADE,null=True,blank=True)
    company = models.ForeignKey(Company,on_delete= models.CASCADE,null=True,blank=True)
    credit_note_history = models.ForeignKey(CreditNote, related_name='credit_note', on_delete=models.CASCADE, null=True, blank=True)    
    CHOICES = [
        ('Created', 'Created'),
        ('Updated', 'Updated'),
    ]
    action = models.CharField(max_length=20, choices=CHOICES)
    hist_date = models.DateTimeField(auto_now_add=True, null=True, blank=True)
